...
void SearchOne(char* fname);
void SearchTwo(char* fname);
int main()
{
...
void Create(char* fname)
{
	...
	do
	{
		...
		case KN:
			...
			student.mid = (student.mat + student.fiz + student.prog) / 3;
			break;
		case ME:
			...
			student.mid = (student.mat + student.fiz + student.pedagog) / 3;
			break;
		case IF:
			...
			student.mid = (student.mat + student.fiz + student.chis_metod) / 3;
			break;
		case FI:
			cout << "оцінка з педагогіки: "; cin >> student.pedagog;
			if (student.pedagog > 5) {
